<x-app-layout>
    ...
    <form method="post" class="max-w-md mx-auto" action="{{ route('store.company') }}" enctype="multipart/form-data">
        @csrf
        <h1 class="text-center text-bold mb-12">Create Your own Company</h1>
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="text" name="industry" id="industry"
                ...
                placeholder=" " required />
            <label for="industry"
                class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Industry</label>
        </div>
        <div class="relative z-0 w-full mb-5 group">
        ...
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-500">Submit
        </button></form>
