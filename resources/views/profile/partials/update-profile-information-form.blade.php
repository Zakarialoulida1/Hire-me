<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="JobTitle" name="JobTitle" type="text" class="mt-1 block w-full" :value="old('JobTitle', $user->JobTitle)"
                required autofocus autocomplete="name" />
        ...
        <div>
            <x-input-label for="Posteactuel" :value="__('Posteactuel')" />
            <x-text-input id="Posteactuel" name="Posteactuel" type="text" class="mt-1 block w-full"
                :value="old('Posteactuel', $user->Posteactuel)" required autofocus autocomplete="name" />
            <x-input-error class="mt-2" :messages="$errors->get('Posteactuel')" />
        </div>
        ...
        <div>
            ...
            <x-text-input id="industrie" name="industrie" type="text" class="mt-1 block w-full" :value="old('industrie', $user->industrie)"
                required autofocus autocomplete="name" />
